...
<head>
	...
	<title>ldp pt lintas data prima </title>
	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.php" class="logo">
				<span class="logo-lg">
					<marquee>
						<b>Aplikasi Tagihan PT Lintas Data Prima Pop Pasuruan(Paket Bulanan)</b>
					</marquee>
				</span>
			</a>
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown messages-menu">
							<a class="dropdown-toggle">
								<span>
									<b>
										Aplikasi Tagihan PT Lintas Data Prima Pop Pasuruan(Paket Bulanan)
									</b>
								</span>
							</a>
						</li>
			...
			<section class="sidebar">
				...
				<div class="user-panel">
					<div class="pull-left image">
						<img src="dist/img/logo1.png" class="" alt="User Image">
					</div>
